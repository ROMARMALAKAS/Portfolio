...
def init_db():
    ...
    # Seed admin user (romar/romar) — no rate limit
    pw_hash = hashlib.sha256("romar".encode()).hexdigest()
    c.execute("INSERT OR REPLACE INTO admin (id, username, password_hash) VALUES (1, 'romar', ?)", (pw_hash,))
...
@app.put("/admin/testimonials/{tid}")
...
@app.delete("/admin/testimonials/{tid}")
...
# --- Admin bookings ---
@app.delete("/_admin/bookings/{date}")
